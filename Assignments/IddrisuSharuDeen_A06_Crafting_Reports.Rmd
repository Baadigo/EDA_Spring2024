...
```{r ozone_boxplot_2018, warning= FALSE, fig.height=3, fig.align='left', echo=FALSE, fig.cap="Ozone levels distribution by month for 2018"}
library(ggplot2)

epa_data_2018 <- epa_data %>% 
  filter(Year == 2018)

p1 <- ggplot(data = epa_data_2018, aes(x=factor(Month), y = Ozone)) +
    geom_boxplot() +
     labs(
    x = "Month",
    y = "Ozone Level",
...
```{r ozone_boxplot_2019, warning= FALSE, fig.height=3, fig.align='left', echo=FALSE, fig.cap="Ozone levels distribution by month for 2019"}
library(ggplot2)

epa_data_2019 <- epa_data %>% 
  filter(Year == 2019)

p2 <- ggplot(data = epa_data_2019, aes(x=factor(Month), y = Ozone)) +
    geom_boxplot() +
     labs(
    x = "Month",
    y = "Ozone Level",
...
## Git Repository
https://github.com/Baadigo/EDA_Spring2024
