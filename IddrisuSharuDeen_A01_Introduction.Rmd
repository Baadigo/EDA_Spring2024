...
> Answer: More recently, I used R and data analytics in general in a Stats course last semester. Before that I did some few R courses on coursera which used some git operations.

2. Are there any components of the course about which you feel confident?

> Answer: Definitely the R and data analytics bit.

3. Are there any components of the course about which you feel apprehensive?

> Answer: Although, I had some initial engagement with git and github, I never quite appreciated how cool it can be until this tutorial. It makes more sense now conceptually, and I can't wait to dive into the nitty gritties. 
...
> Answer: https://github.com/Baadigo/EDA_Spring2024.git
